...
public class Chat {
    ...
    public static String send(Plugin pl, Player p, String message) {
        String current = ChatColor.translateAlternateColorCodes('&', pl.getConfig().getString(message));
        if (!(p == null)) {
            String[][] replacements = new String[][] {
                    {"{player.name}", p.getName()},
                    {"{player.display_name}", p.getDisplayName()}
            };
